...
import WatchPageSkeleton from '../component/skeltons/watchPageSkelton.jsx';
...
const WatchPage = () => {
    ...
    const[similerContents,setSimilarContents]=useState([])
 ...
 useEffect(()=>{
    ...
    const handleNext = () => {
		if (currentTrailerIdx < trailer.length - 1) setCurrentTrailerIdx(currentTrailerIdx + 1);
	};
	const handlePrev = () => {
...
<div
				...
				{similerContents.length > 0 && (
					<div className='mt-12 max-w-5xl mx-auto relative'>
						<h3 className='text-3xl font-bold mb-4'>Similar Movies/Tv Show</h3>

						<div className='flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group' ref={sliderRef}>
							{similerContents.map((content) => {
