        ...
        <>
            <div className="h-screen relative  text-white ">
                ...
                <div className="max-w-2xl ">
                  ...
                  {trendingContent?.title || trendingContent?.name}</h1>
              ...
              {trendingContent?.overview.length>200 ? trendingContent?.overview.slice(0,200)+"..." : trendingContent?.overview}
                ...
                <div className="mt-8  flex gap-3">
                  <Link to='/watch/123' className="bg-white hover:bg-white/80 text-black px-4 py-2 flex items-center rounded-md text-lg font-medium
                  ">
                 <Play className="size-6  mr-2 fill-black"/> Play</Link>

                  <Link to='/watch/123' className="bg-gray-500/70 hover:bg-gray-500 text-white px-4 py-2 flex items-center rounded-md text-lg font-medium
                  ">
                 <Info className="size-6  mr-2 "/> More</Link>
