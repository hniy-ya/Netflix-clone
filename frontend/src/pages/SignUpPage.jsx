        ...
        <div className="flex justify-center items-center mt-20 mx-3">
            <div className="w-full max-w-md  p-8 space-y-6 bg-black/60 rounded-lg shadow-md">
                ...
                <form action="" className="space-y-4" onSubmit={handleSignUp}>
                    ...
                    <input type="text" className="w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent text-white focus:outline-none focus:ring" placeholder="Your name" id="username" onChange={(e)=>setUsername(e.target.value)} value={username}/>
                    </div>
                ...
                <div className="text-gray-400 text-center">Already a member?{" "}
                    <Link to={'/login'} className="text-red-400 hover:underline">Sign in</Link> </div>
            </div>
        </div>
